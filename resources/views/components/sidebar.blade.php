<aside class="sidebar-bg w-72 flex-shrink-0 flex flex-col shadow-2xl z-20">
            <div class="px-8 pt-10 pb-6 fade-up">
                ...
                <p class="text-forest-300 text-[10px] uppercase tracking-[0.2em] font-bold">Main Navigation</p>
            </div>

            <nav class="flex-1 flex flex-col gap-2 px-4">
                <a href="{{ route('receptionist.index') }}"
                    class="flex items-center gap-4 px-4 py-3.5 rounded-xl text-white bg-white/10 border border-white/10 hover:bg-white/15 hover:border-white/30 transition-all duration-300 group fade-up">
                    <span class="w-10 h-10 rounded-lg bg-forest-600/50 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-[10px] text-forest-300 group-hover:text-white transition-colors">Kelola tamu hari ini</span>
                    </div>
                </a>
            </nav>
