                ...
                <div class="absolute right-0 pt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right translate-y-2 group-hover:translate-y-0 z-50">
                    <div class="bg-white rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                        <div class="p-2 space-y-1">
                            <a href="{{ route('profile.edit') }}" class="block px-4 py-2.5 text-sm font-semibold text-gray-600 hover:bg-[#FFF4DE] hover:text-[#8C6A1A] rounded-lg transition-colors">UBAH PROFIL</a>
                            <a href="{{ route('profile.orders') }}" class="block px-4 py-2.5 text-sm font-semibold text-gray-600 hover:bg-[#FFF4DE] hover:text-[#8C6A1A] rounded-lg transition-colors">PESANAN SAYA</a>
                            <a href="{{ route('profile.reviews') }}" class="block px-4 py-2.5 text-sm font-semibold text-gray-600 hover:bg-[#FFF4DE] hover:text-[#8C6A1A] rounded-lg transition-colors">REVIEW SAYA</a>
