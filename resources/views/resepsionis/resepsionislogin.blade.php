...
<body class="bg-[#0f1711] min-h-screen relative flex items-center justify-center font-sans">
    ...
    <div class="relative z-10 w-full max-w-[420px] px-6">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="mt-6 text-2xl font-light text-white tracking-wide">Portal <span class="font-bold text-[#D4AF37]">Resepsionis</span></h1>
            <p class="text-white/50 text-sm mt-2">Masuk untuk melayani tamu hotel.</p>
        </div>
