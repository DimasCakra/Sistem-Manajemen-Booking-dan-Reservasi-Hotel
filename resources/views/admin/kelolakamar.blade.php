    ...
    <main class="flex-1 overflow-y-auto px-4 md:px-10 py-6 md:py-10">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-10 fade-up">
            <div>
                ...
                <p class="text-forest-500 mt-2 text-sm uppercase tracking-widest font-semibold">Manajemen Kamar</p>
            </div>
        ...
        <form id="searchFilterForm" method="GET" action="{{ route('admin.kamar') }}" class="mb-6 flex flex-col md:flex-row gap-4 items-center justify-between fade-up" style="animation-delay: 0.05s">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto items-stretch sm:items-center">
                ...
                <button type="submit" class="w-full md:w-auto px-5 py-3 bg-forest-700 hover:bg-forest-800 text-white text-sm font-semibold rounded-xl transition-all whitespace-nowrap">
                    Cari
                </button>
            </div>
        </form>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left min-w-[800px]">
                    ...
                    <tbody class="divide-y divide-gray-100" id="roomTableBody">
                        ...
                        @empty
                            <tr><td colspan="7" class="px-8 py-12 text-center text-sm text-slate-500 font-semibold">Tidak ada kamar ditemukan.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div id="createModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4 py-6">
        <div class="w-full max-w-2xl rounded-3xl bg-white shadow-2xl ring-1 ring-black/5 flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <form action="{{ route('admin.kamar.store') }}" method="POST" class="flex-1 overflow-y-auto px-8 py-5 space-y-5">
                ...
                <div class="text-sm text-slate-500">Harga, deskripsi, and foto akan mengikuti pilihan tipe kamar.</div>
