...
<head>
    ...
    <title>Detail Tamu - Admin StayEase</title>
...
<body class="bg-[#FFF4DE] min-h-screen flex">
    ...
    <main class="flex-1 overflow-y-auto px-10 py-10">
        <div class="mb-10 fade-up">
            <a href="{{ route('admin.tamu') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-forest-700 hover:text-forest-900">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <div class="rounded-3xl border border-slate-200 p-5 bg-slate-50">
                            <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Nomor Identitas</p>
                            <p class="mt-2 font-semibold text-slate-900">{{ $tamu->id_type ?? 'NIK' }}: {{ $tamu->id_number ?? '-' }}</p>
                        </div>
                        <div class="rounded-3xl border border-slate-200 p-5 bg-slate-50">
