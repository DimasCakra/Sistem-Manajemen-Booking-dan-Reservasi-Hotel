...
<body class="bg-white min-h-screen font-sans flex">
    ...
    <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div class="absolute bottom-16 left-16 right-16 text-white">
            ...
            <p class="text-white/90 text-xl max-w-lg leading-relaxed font-light">Pengalaman menginap yang nyaman dan layanan terbaik menanti anda, hanya dengan beberapa langkah.</p>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 lg:p-24 relative bg-[#FFF4DE]">
        ...
        <div class="w-full max-w-md">
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl font-bold text-[#173014] mb-3 font-serif">Masuk</h1>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input id="email" type="email" name="email" required autocomplete="email" placeholder="Alamat Email"
