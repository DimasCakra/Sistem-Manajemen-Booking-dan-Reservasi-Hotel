document.addEventListener("DOMContentLoaded", () => {
    ...
    const editTanggalLahirInput = document.getElementById("editTanggalLahir"); // Tambahan baru
    ...
    modalCloseButtons.forEach((button) => {
        button.addEventListener("click", () => {
            const targetModal =
                button.closest("#createModal") ||
                button.closest("#editModal") ||
                button.closest("#deleteModal");
    ...
    if (tableBody) {
        tableBody.addEventListener("click", (event) => {
            ...
            if (editBtn) {
                ...
                const birthday = editBtn.dataset.birthday; // Tambahan baru
                ...
                if (editForm) {
                    ...
                    if (editTanggalLahirInput)
                        editTanggalLahirInput.value = birthday || ""; // Tambahan baru
